...
\end{proof}
\subsection{Sobolev Inequalities}\label{Sec4.6}
...
Now let's suppose $n<p<\infty$. We will show that if $u\in W^{1,p}(U)$, then $u$ is in fact Holder continuous, after possibly being redefined on a set of measure zero.
